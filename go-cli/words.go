...
func registerSDKWords(r *eng.Registry, client *sdk.ApiToolsSDK) {
...
func runOp(client *sdk.ApiToolsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/api-tools` | `npm install @voxgig-sdk/api-tools` |
| Python | `voxgig-sdk-api-tools` | `pip install voxgig-sdk-api-tools` |
| PHP | `voxgig-sdk/api-tools` | `composer require voxgig-sdk/api-tools` |
| Golang | `github.com/voxgig-sdk/api-tools-sdk/go` | `go get github.com/voxgig-sdk/api-tools-sdk/go` |
| Ruby | `voxgig-sdk-api-tools` | `gem install voxgig-sdk-api-tools` |
| Lua | `voxgig-sdk-api-tools` | `luarocks install voxgig-sdk-api-tools` |

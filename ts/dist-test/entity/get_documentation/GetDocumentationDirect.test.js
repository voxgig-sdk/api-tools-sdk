...
(0, node_test_1.describe)('GetDocumentationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-get_documentation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_documentation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.API_TOOLS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ApiToolsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['API_TOOLS_TEST_GET_DOCUMENTATION_ENTID'];
    ...
    const client = new __1.ApiToolsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetDocumentationDirect.test.js.map
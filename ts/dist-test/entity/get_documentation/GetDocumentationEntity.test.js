...
(0, node_test_1.describe)('GetDocumentationEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/get_documentation/GetDocumentationTestData.json');
    ...
    let idmap = transform(['get_documentation01', 'get_documentation02', 'get_documentation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GetDocumentationEntity.test.js.map
...
(0, node_test_1.describe)('EncodingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != encoding_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/encoding/EncodingTestData.json');
    ...
    let idmap = transform(['encoding01', 'encoding02', 'encoding03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EncodingEntity.test.js.map
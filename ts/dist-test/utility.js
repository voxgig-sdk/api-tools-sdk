...
function envOverride(m) {
    if ('TRUE' === process.env.API_TOOLS_TEST_LIVE ||
        'TRUE' === process.env.API_TOOLS_TEST_OVERRIDE) {
    ...
    m.API_TOOLS_TEST_EXPLAIN = process.env.API_TOOLS_TEST_EXPLAIN || m.API_TOOLS_TEST_EXPLAIN;
    return m;
}

...
local GetDocumentationEntity = {}
GetDocumentationEntity.__index = GetDocumentationEntity


function GetDocumentationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetDocumentationEntity)
  self._name = "get_documentation"
  self._client = client
...
function GetDocumentationEntity:get_name()
  return self._name
end


function GetDocumentationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetDocumentationEntity.new(self._client, opts)
end
...
function GetDocumentationEntity:mark_deleted()
  self._deleted = true
end


function GetDocumentationEntity:deleted()
  return true == self._deleted
end


function GetDocumentationEntity:data_set(args)
  if args ~= nil then
...
function GetDocumentationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetDocumentationEntity:match_set(args)
  if args ~= nil then
...
function GetDocumentationEntity:match_get()
...
function GetDocumentationEntity:stream(action, args, callopts)
...
---@param reqmatch GetDocumentationListMatch
---@param ctrl? table
---@return GetDocumentation[]
---@return string? err
function GetDocumentationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetDocumentationEntity:_run_op(ctx, post_done)
  local utility = self._utility

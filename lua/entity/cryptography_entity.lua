...
local CryptographyEntity = {}
CryptographyEntity.__index = CryptographyEntity


function CryptographyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CryptographyEntity)
  self._name = "cryptography"
  self._client = client
...
function CryptographyEntity:get_name()
  return self._name
end


function CryptographyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CryptographyEntity.new(self._client, opts)
end
...
function CryptographyEntity:mark_deleted()
  self._deleted = true
end


function CryptographyEntity:deleted()
  return true == self._deleted
end


function CryptographyEntity:data_set(args)
  if args ~= nil then
...
function CryptographyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CryptographyEntity:match_set(args)
  if args ~= nil then
...
function CryptographyEntity:match_get()
...
function CryptographyEntity:stream(action, args, callopts)
...
---@param reqdata CryptographyCreateData
---@param ctrl? table
---@return Cryptography
---@return string? err
function CryptographyEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CryptographyEntity:_run_op(ctx, post_done)
  local utility = self._utility

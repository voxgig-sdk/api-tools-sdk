...
local ApiToolsSDK = {}
ApiToolsSDK.__index = ApiToolsSDK
...
ApiToolsSDK._make_feature = _make_feature


function ApiToolsSDK.new(options)
  local self = setmetatable({}, ApiToolsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function ApiToolsSDK:options_map()
...
function ApiToolsSDK:get_utility()
  return Utility.copy(self._utility)
end


function ApiToolsSDK:get_root_ctx()
  return self._rootctx
end


function ApiToolsSDK:prepare(fetchargs)
...
function ApiToolsSDK:direct(fetchargs)
...
-- by passing it.
function ApiToolsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ApiToolsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ApiToolsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function ApiToolsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = ApiToolsSDK.new(sdkopts)
  sdk.mode = "test"

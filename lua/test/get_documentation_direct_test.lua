...
describe("GetDocumentationDirect", function()
  it("should direct-list-get_documentation", function()
    local setup = get_documentation_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_documentation", setup.live and "live" or "unit")
...
function get_documentation_direct_setup(mockres)

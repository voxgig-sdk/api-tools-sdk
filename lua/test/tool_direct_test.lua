...
describe("ToolDirect", function()
  it("should direct-list-tool", function()
    local setup = tool_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tool", setup.live and "live" or "unit")

...
local SDK_MODULE = "api-tools_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["cryptography"] = { ["test01"] = { id = "test01" } }, ["encoding"] = { ["test01"] = { id = "test01" } }, ["generator"] = { ["test01"] = { id = "test01" } }, ["get_documentation"] = { ["test01"] = { id = "test01" } }, ["tool"] = { ["test01"] = { id = "test01" } }, ["utility"] = { ["test01"] = { id = "test01" } } } }'

...
class GeneratorEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set API_TOOLS_TEST_GENERATOR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function generator_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("API_TOOLS_TEST_GENERATOR_ENTID");

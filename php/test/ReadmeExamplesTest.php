...
// ApiTools SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ApiToolsSDK::test)
...
{
    private const SDK_CLASS = 'ApiToolsSDK';
    ...
    private const SDK_BASE = 'apitools_sdk';

...
class EncodingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set APITOOLS_TEST_ENCODING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function encoding_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("APITOOLS_TEST_ENCODING_ENTID");

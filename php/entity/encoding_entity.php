...
class EncodingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EncodingEntity($this->_client, $opts);
    }

    /**
     * @param Encoding|array $args Encoding data (assoc-array) to store.
     */
    ...
    /**
     * @return Encoding|array The current Encoding data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Encoding fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Encoding fields).
     */
     ...
     *
     * @param EncodingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EncodingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Encoding|array The created Encoding as an assoc-array at the

...
class ToolEntity
{
     ...
     *
     * @param ToolListMatch|array|null $reqmatch Match filter (any subset
     *   of Tool fields) as an assoc-array; ToolListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tool[]|array A list of Tool items as assoc-arrays at

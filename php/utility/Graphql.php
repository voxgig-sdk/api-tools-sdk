...
class ApiToolsGraphql
{
    ...
    // equivalent.
    public static function body(ApiToolsContext $ctx): mixed
    {
    ...
    public static function errors(ApiToolsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

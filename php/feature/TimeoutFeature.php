...
class ApiToolsTimeoutFeature extends ApiToolsBaseFeature
{
    ...
    private function _with_timeout(ApiToolsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ApiToolsContext $_ctx, float $ms): void
    {
        $client = $this->client;

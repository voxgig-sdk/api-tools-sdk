...
// ApiTools SDK streaming feature
...
class ApiToolsStreamingFeature extends ApiToolsBaseFeature
{
    ...
    private function _iterate(ApiToolsResult $result): \Generator
    {
    ...
    private function _streamable(ApiToolsContext $ctx): bool
    {

...
// ApiTools SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ApiToolsTestFeature extends ApiToolsBaseFeature
{
    ...
    public function init(ApiToolsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ApiToolsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ApiToolsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ApiToolsContext $ctx, $op, $args): array
    {

...
// ApiTools SDK ratelimit feature
...
class ApiToolsRatelimitFeature extends ApiToolsBaseFeature
{
    ...
    private function _acquire(ApiToolsContext $ctx): void
    {
    ...
    private function _track(ApiToolsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

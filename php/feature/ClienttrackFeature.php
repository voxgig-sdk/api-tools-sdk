...
// ApiTools SDK clienttrack feature
...
class ApiToolsClienttrackFeature extends ApiToolsBaseFeature
{
    ...
    public function PostConstruct(ApiToolsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ApiTools-SDK';

...
class GeneratorEntity
  ...
  # @return [Generator, Hash] the loaded Generator; raises ApiToolsError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Generator>, Array] the matching Generator items; raises ApiToolsError on failure

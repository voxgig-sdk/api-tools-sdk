...
class GeneratorEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set API_TOOLS_TEST_GENERATOR_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def generator_basic_setup(extra)
  ...
  entid_env_raw = ENV["API_TOOLS_TEST_GENERATOR_ENTID"]

...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ApiToolsOmni.make_runner(TEST_JSON_FILE, ApiToolsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ApiToolsOmni.errify(err)
    end

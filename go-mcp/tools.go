...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cryptography | encoding | generator | get_documentation | tool | utility"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ApiToolsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "api-tools_list",
		Description: "List records from ApiTools. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "api-tools_load",
		Description: "Load a single record from ApiTools. " +
...
func runOp(client *sdk.ApiToolsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ApiToolsSDK, name string) (sdk.ApiToolsEntity, error) {
	switch strings.ToLower(name) {
	case "cryptography":
		return client.Cryptography(nil), nil
	case "encoding":
		return client.Encoding(nil), nil
	case "generator":
		return client.Generator(nil), nil
	case "get_documentation":
		return client.GetDocumentation(nil), nil
	case "tool":

...
class ApiToolsCacheFeature extends ApiToolsBaseFeature
{
    ...
    private function _through(ApiToolsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

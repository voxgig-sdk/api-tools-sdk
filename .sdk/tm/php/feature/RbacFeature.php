...
class ApiToolsRbacFeature extends ApiToolsBaseFeature
{
    ...
    private function _required(ApiToolsContext $ctx): ?string
    {
    ...
    private function _reject(ApiToolsContext $ctx, string $required): void
    {
    ...
    private function _track(ApiToolsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

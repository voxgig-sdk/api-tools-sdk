...
class ApiToolsProxyFeature extends ApiToolsBaseFeature
{
    ...
    public function init(ApiToolsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ApiToolsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

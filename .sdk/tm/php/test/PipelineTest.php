...
{
    private static function utility(): ApiToolsUtility
    {
        return new ApiToolsUtility();
    }
    ...
    private static function ctx(array $over = []): ApiToolsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ApiToolsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ApiToolsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ApiToolsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ApiToolsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ApiToolsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ApiToolsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ApiToolsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ApiToolsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ApiToolsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApiToolsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ApiToolsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ApiToolsResponse([]),
            'result' => new ApiToolsResult([]),
        ]);
        [, $err] = ApiToolsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ApiToolsSpec([]),
            'response' => null,
            'result' => new ApiToolsResult([]),
        ]);
        [, $err] = ApiToolsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ApiToolsSpec(['step' => 's']),
            'response' => new ApiToolsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ApiToolsResult([]),
        ]);
        [, $err] = ApiToolsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ApiToolsSpec(['step' => 's']),
            'response' => new ApiToolsResponse(self::resp(200, ['v' => 1])),
            'result' => new ApiToolsResult([]),
        ]);
        [, $err] = ApiToolsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ApiToolsSpec(['step' => 's']),
            'response' => new ApiToolsResponse(self::resp(200, ['v' => 2])),
            'result' => new ApiToolsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ApiToolsMakeResponse::call($ctx);
    ...
    {
        $preset = new ApiToolsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ApiToolsSpec([]),
            'response' => new ApiToolsResponse([]),
            'result' => new ApiToolsResult([]),
        ...
        [$got, $err] = ApiToolsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ApiToolsResult([])]);
        [, $err] = ApiToolsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ApiToolsSpec([]), 'result' => null]);
        [, $err] = ApiToolsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApiToolsSpec(['step' => 's']),
            'result' => new ApiToolsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ApiToolsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApiToolsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ApiToolsSpec(['step' => 's']),
            'result' => new ApiToolsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ApiToolsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ApiToolsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ApiToolsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ApiToolsSpec([]),
            'result' => new ApiToolsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ApiToolsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApiToolsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ApiToolsError('boom', 'boom');
        $utility->fetcher = function (ApiToolsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApiToolsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ApiToolsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ApiToolsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ApiToolsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ApiToolsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ApiToolsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ApiToolsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ApiToolsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ApiToolsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ApiToolsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ApiToolsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ApiToolsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ApiToolsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ApiToolsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ApiToolsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ApiToolsResult(['ok' => false])]);
        $this->expectException(ApiToolsError::class);
        ApiToolsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ApiToolsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ApiToolsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ApiToolsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ApiToolsBaseFeature();
        $b = new ApiToolsBaseFeature();
        ApiToolsFeatureAdd::call($ctx, $a);
        ApiToolsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ApiToolsBaseFeature
    {
        $f = new ApiToolsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ApiToolsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ApiToolsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ApiToolsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ApiToolsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ApiToolsResponse(['headers' => null]),
            'result' => new ApiToolsResult([]),
        ]);
        ApiToolsResultHeaders::call($ctx);

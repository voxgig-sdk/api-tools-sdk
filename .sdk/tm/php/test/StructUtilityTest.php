...
// ApiTools SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ApiToolsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ApiToolsOmni::structfix($now, Struct::undef()))
                        !== json_encode(ApiToolsOmni::structfix($val, Struct::undef()))) {

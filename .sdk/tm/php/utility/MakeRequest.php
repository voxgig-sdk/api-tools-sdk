...
// ApiTools SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ApiToolsMakeRequest
{
    public static function call(ApiToolsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ApiToolsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ApiToolsResponse($fetched);
        } else {

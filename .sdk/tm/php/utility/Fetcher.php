...
// ApiTools SDK utility: fetcher

class ApiToolsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ApiToolsSDK/1.0)';
    ...
    public static function call(ApiToolsContext $ctx, string $fullurl, array $fetchdef): array
    {

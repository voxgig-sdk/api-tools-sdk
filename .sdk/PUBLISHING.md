...
|---|---|---|
| `ts/` | @voxgig-sdk/api-tools-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/api-tools-sdk \
      --repository voxgig-sdk/api-tools-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/api-tools-sdk` shows it, and
`npm trust revoke @voxgig-sdk/api-tools-sdk --id=<id>` removes it.

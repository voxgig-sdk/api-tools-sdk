...
const testSeed = `map[string]any{"entity": map[string]any{"cryptography": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "encoding": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "generator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_documentation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tool": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "utility": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

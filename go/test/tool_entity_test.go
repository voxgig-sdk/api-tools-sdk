...
func TestToolEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set APITOOLS_TEST_TOOL_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func toolBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("APITOOLS_TEST_TOOL_ENTID")
	...
	idmapResolved := core.ToMapAny(env["APITOOLS_TEST_TOOL_ENTID"])

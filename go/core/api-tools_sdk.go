...
func (sdk *ApiToolsSDK) OptionsMap() map[string]any {
...
func (sdk *ApiToolsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ApiToolsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ApiToolsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ApiToolsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ApiToolsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ApiToolsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ApiToolsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ApiToolsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ApiToolsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ApiToolsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

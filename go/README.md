...
The Golang SDK for the ApiTools API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/api-tools-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/api-tools-sdk=../path/to/github.com/voxgig-sdk/api-tools-sdk
```
...
```
github.com/voxgig-sdk/api-tools-sdk/
...
The root package (`github.com/voxgig-sdk/api-tools-sdk`) re-exports everything needed

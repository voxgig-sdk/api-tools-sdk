...
func (e *CryptographyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CryptographyEntity) Deleted() bool {
	return e.deleted
}
...
func (e *CryptographyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)

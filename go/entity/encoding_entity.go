...
func NewEncodingEntity(client *core.ApiToolsSDK, entopts map[string]any) *EncodingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EncodingEntity) GetName() string { return e.name }
...
func (e *EncodingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EncodingEntity) Deleted() bool {
	return e.deleted
}


func (e *EncodingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEncodingEntity(e.client, opts)
}

func (e *EncodingEntity) Data(args ...any) any {
...
func (e *EncodingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Encoding; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EncodingEntity) DataTyped(data ...Encoding) Encoding {
	if len(data) > 0 {
		return typedFrom[Encoding](e.Data(asMap(data[0])))
	}
	return typedFrom[Encoding](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Encoding (all fields
// optional at the wire level).
func (e *EncodingEntity) MatchTyped(match ...Encoding) Encoding {
	if len(match) > 0 {
		return typedFrom[Encoding](e.Match(asMap(match[0])))
	}
	return typedFrom[Encoding](e.Match())
}
...
func (e *EncodingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EncodingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EncodingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EncodingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EncodingCreateData and returns an Encoding. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EncodingEntity) CreateTyped(reqdata EncodingCreateData, ctrl map[string]any) (Encoding, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Encoding{}, err
	}
	return typedFrom[Encoding](res), nil
}



func (e *EncodingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EncodingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EncodingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

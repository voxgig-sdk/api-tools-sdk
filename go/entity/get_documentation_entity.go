...
type GetDocumentationEntity struct {
	name    string
...
func NewGetDocumentationEntity(client *core.ApiToolsSDK, entopts map[string]any) *GetDocumentationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetDocumentationEntity) GetName() string { return e.name }
...
func (e *GetDocumentationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetDocumentationEntity) Deleted() bool {
	return e.deleted
}


func (e *GetDocumentationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetDocumentationEntity(e.client, opts)
}

func (e *GetDocumentationEntity) Data(args ...any) any {
...
func (e *GetDocumentationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetDocumentation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetDocumentationEntity) DataTyped(data ...GetDocumentation) GetDocumentation {
	if len(data) > 0 {
		return typedFrom[GetDocumentation](e.Data(asMap(data[0])))
	}
	return typedFrom[GetDocumentation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetDocumentation (all fields
// optional at the wire level).
func (e *GetDocumentationEntity) MatchTyped(match ...GetDocumentation) GetDocumentation {
	if len(match) > 0 {
		return typedFrom[GetDocumentation](e.Match(asMap(match[0])))
	}
	return typedFrom[GetDocumentation](e.Match())
}
...
func (e *GetDocumentationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetDocumentationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetDocumentationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetDocumentationListMatch and returns []GetDocumentation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetDocumentationEntity) ListTyped(reqmatch GetDocumentationListMatch, ctrl map[string]any) ([]GetDocumentation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetDocumentation](res), nil
}



func (e *GetDocumentationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetDocumentationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetDocumentationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetDocumentationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

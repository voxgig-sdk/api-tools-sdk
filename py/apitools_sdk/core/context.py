...
from apitools_sdk.core.control import ApiToolsControl
...
from apitools_sdk.core.helpers import get_ctx_prop, to_map
...
class ApiToolsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ApiToolsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ApiToolsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ApiToolsError(code, msg, self)

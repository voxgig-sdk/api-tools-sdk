...
from apitools_sdk.utility import register

# Load features
from apitools_sdk.feature.base_feature import ApiToolsBaseFeature
from apitools_sdk.features import _has_feature, _make_feature
...
class ApiToolsSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ApiToolsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cryptography(self, data=None) -> "CryptographyEntity":
        ...
        from apitools_sdk.entity.cryptography_entity import CryptographyEntity
    ...
    def Encoding(self, data=None) -> "EncodingEntity":
        ...
        from apitools_sdk.entity.encoding_entity import EncodingEntity
    ...
    def Generator(self, data=None) -> "GeneratorEntity":
        ...
        from apitools_sdk.entity.generator_entity import GeneratorEntity
    ...
    def GetDocumentation(self, data=None) -> "GetDocumentationEntity":
        ...
        from apitools_sdk.entity.get_documentation_entity import GetDocumentationEntity
    ...
    def Tool(self, data=None) -> "ToolEntity":
        ...
        from apitools_sdk.entity.tool_entity import ToolEntity
    ...
    def Utility(self, data=None) -> "UtilityEntity":
        ...
        from apitools_sdk.entity.utility_entity import UtilityEntity

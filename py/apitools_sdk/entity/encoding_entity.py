...
class EncodingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EncodingEntity(self._client, opts)
    ...
    def create(self, reqdata: EncodingCreateData, ctrl=None) -> Encoding:
        utility = self._utility

...
from apitools_sdk.apitools_types import (
    Cryptography,
...
class CryptographyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CryptographyEntity(self._client, opts)
    ...
    def data_get(self) -> Cryptography:
    ...
    def match_get(self) -> Cryptography:
    ...
    def create(self, reqdata: CryptographyCreateData, ctrl=None) -> Cryptography:
        utility = self._utility

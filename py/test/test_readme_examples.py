# ApiTools SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ApiToolsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ApiToolsSDK(...) and ApiToolsSDK.test(...) become
#      ApiToolsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "apitools_sdk"
_SDK_CLASS = "ApiToolsSDK"

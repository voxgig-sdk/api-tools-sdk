...
from apitools_sdk.core.spec import ApiToolsSpec
from apitools_sdk.core.result import ApiToolsResult
from apitools_sdk.core.response import ApiToolsResponse
from apitools_sdk.core.operation import ApiToolsOperation
from apitools_sdk.core.error import ApiToolsError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ApiToolsSDK.test(None, None)
        ...
        class TestInitFeature(ApiToolsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ApiToolsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ApiToolsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ApiToolsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ApiToolsSDK.test(None, setup_opts)

...
class ApiToolsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ApiToolsTestRunner.getenv("APITOOLS_TEST_LIVE")
        override = ApiToolsTestRunner.getenv("APITOOLS_TEST_OVERRIDE")
        ...
        explain = ApiToolsTestRunner.getenv("APITOOLS_TEST_EXPLAIN")

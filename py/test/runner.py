...
class ApiToolsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ApiToolsTestRunner.getenv("API_TOOLS_TEST_LIVE")
        override = ApiToolsTestRunner.getenv("API_TOOLS_TEST_OVERRIDE")
        ...
        explain = ApiToolsTestRunner.getenv("API_TOOLS_TEST_EXPLAIN")
